...
class ProfProductUpdateState extends Equatable {
  ...
  ProfProductUpdateState restForm() {
    return ProfProductUpdateState(file2: null);
  }

  ProfProductUpdateState copyWith(
      {BlocForItem? name,
      int? idcategory,
      int? iduser,
