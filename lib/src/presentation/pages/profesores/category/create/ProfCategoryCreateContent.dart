...
class ProfCategoryCreateContent extends StatelessWidget {
  ProfCategoryCreateBloc? bloc;
  ProfCategoryCreateState state;

  ProfCategoryCreateContent(this.bloc, this.state);
