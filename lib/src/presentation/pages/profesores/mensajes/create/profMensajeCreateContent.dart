...
class profMensajeCreateContent extends StatelessWidget {
  profMensajeCreateBloc? bloc;
  profMensajeCreateState state;

  profMensajeCreateContent(this.bloc, this.state);
