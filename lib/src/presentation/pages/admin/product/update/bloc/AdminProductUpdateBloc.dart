...
class AdminProductUpdateBloc
  ...
  AdminProductUpdateBloc(this.productsUseCase)
      : super(AdminProductUpdateState()) {
    on<AdminProductUpdateInitEvent>(_onInitevEvent);
  ...
  Future<void> _onInitevEvent(AdminProductUpdateInitEvent event,
  ...
  Future<void> _onNameChanged(
      NameChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        name: BlocForItem(
  ...
  Future<void> _onpriceChanged(
      PriceChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        price: BlocForItem(
  ...
  Future<void> _ondescriptionChanged(
      DescriptionChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
  ...
  Future<void> _onCompventaChanged(
      CompventaChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
  ...
  Future<void> _onprice1Changed(
      Price1Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        price1: BlocForItem(
  ...
  Future<void> _onprice2Changed(
      Price2Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        price2: BlocForItem(
  ...
  Future<void> _onSlChanged(
      SlChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        sl: BlocForItem(
  ...
  Future<void> _onTp1Changed(
      Tp1Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        tp1: BlocForItem(
  ...
  Future<void> _onTp2Changed(
      Tp2Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        tp2: BlocForItem(
  ...
  Future<void> _onTp3Changed(
      Tp3Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        tp3: BlocForItem(
  ...
  Future<void> _onTp4Changed(
      Tp4Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        tp4: BlocForItem(
  ...
  Future<void> _onTp5Changed(
      Tp5Changed event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        tp5: BlocForItem(
  ...
  Future<void> _onestadchage(
      EstadChanged event, Emitter<AdminProductUpdateState> emit) async {
    emit(state.copyWith(
        estad: BlocForItem(
